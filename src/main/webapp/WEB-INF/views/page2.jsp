...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Workspace
                <small>- provide the use cases and application related information</small>
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">Desktop Application - FE 1</div>
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">Mobile Application - FE 2</div>
                                        <div class="panel-body">
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <label><input type="checkbox" name="useCaseDB1"
                                                ...
                                                <div class="col-md-1">
                                                    <label><input type="checkbox" name="feDesktop1"
                                                                  value="feDesktop1">FE 1</label>
                                                </div><!-- /.col-lg-3 -->

                                                <div class="col-md-1">
                                                    <label><input type="checkbox" name="feMobile1"
                                                                  value="feMobile1">FE 2</label>
                                                </div><!-- /.col-lg-3 -->
...
<script>
  ...
  function addUseCaseDetails() {
    ...
    html += '<label><input type="checkbox" name="feDesktop' + useCaseCount + '" value="feDesktop' + useCaseCount + '">FE 1</label>';
    html += '</div>';

    html += '<div class="col-md-1">';
    html += '<label><input type="checkbox" name="feMobile' + useCaseCount + '" value="feMobile' + useCaseCount + '">FE 2</label>';
    html += '</div>';
